...
[![Portfolio](https://img.shields.io/badge/portfolio-hoseunggg.com-2ea44f?style=flat-square\&labelColor=555555)](www.hoseunggg.com)
...
- **Bitcoin ML Prediction** - Cryptocurrency price prediction model ([GitHub](https://github.com/hoseunggg/Bitcoin_prediction))
- **AI Date Planner** - LLM-powered date course recommendation service ([Demo](https://date-llm-project-8fvxphzzv-hoseunggg-1610s-projects.vercel.app))
- **Drone Simulation** - LiDAR sensor error analysis
- **Speech Recognition Optimization** - Comparative study of recognition algorithms
